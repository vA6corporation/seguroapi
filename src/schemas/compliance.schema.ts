...
ComplianceSchema.virtual('guaranteeType').get(function() {
  return 'GFCF';
});

ComplianceSchema.virtual('customer', {
  ref: Customer.name,
...
ComplianceSchema.virtual('financier', {
  ref: Financier.name,
...
ComplianceSchema.virtual('beneficiary', {
...
ComplianceSchema.virtual('partnership', {
